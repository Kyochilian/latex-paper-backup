...
空间多组学技术能够同时测量组织结构、空间数据及多层分子信息，为解析细胞组织与组织异质性提供了新的机会，在生理病理领域至关重要。近年来，基于空间多组学的整合分析取得了显著进展，基于机器学习的聚类整合方法应运而生。
然而，当前的空间多组学聚类仍然面临挑战，现有方法存在诸多不足，其基于图的方法不足以表示复杂的生物组织拓扑结构，并且会丢失全局上下文。在后续的information fusion中，大多方法仅限于简单的加权与连接，无法有效整合各空间组学的信息；同时，
深聚类在不平衡空间域下容易出现 cluster collapse，容易出现簇塌陷或次优整合。
