...
同样地，local branch的初始窗口分块可以表示为\begin{equation}F_{0}\xrightarrow{\;w_l\;}\{\ell_{1},\ell_{2},\dots,\ell_{m_\ell}\}\end{equation}
...
由图\ref{Bi-WKV注意力机制的示意图}，注意力核心的计算复杂度为\begin{equation}O=(2TC).\end{equation}
